...
{
  uint8_t *addresses[27] = {
    &iram->separated.BaS[0], &iram->separated.BaS[1],
    &iram->separated.BaS[2], &iram->separated.BaS[3],
    &iram->separated.BaS[4], &iram->separated.BaS[5],
    &iram->separated.BaS[6], &iram->separated.BaS[7],
    &iram->separated.BaS[8], &iram->separated.BaS[9],
    &iram->separated.BaS[10], &iram->separated.BaS[11],
    &iram->separated.BaS[12], &iram->separated.BaS[13],
    &iram->separated.BaS[14], &iram->separated.BaS[15],
    &iram->separated.SFR.P0, &iram->separated.SFR.TCON,
    &iram->separated.SFR.P1, &iram->separated.SFR.SCON,
    &iram->separated.SFR.P2, &iram->separated.SFR.IE,
    &iram->separated.SFR.P3, &iram->separated.SFR.IP,
    &iram->separated.SFR.PSW, &iram->separated.SFR.A,
    &iram->separated.SFR.B,
  };
  for (uint8_t i = 0; i < 27; i++) {
    for (uint8_t j = 0; j < 8; j++) {
      iram_balt[i*8+j].ptr = addresses[i];
...
void init_rom(rom_t *rom, rom_t *custom_rom, bool is_custom)
{
  ...
  //    NOP             (30 - 4095)
      ...
      [18] = 0b00101010, [19] = 0b01010111, [20] = 0b01010100,
      [21] = 0b00011000, [22] = 0b01010010, [23] = 0b00000000,
      [24] = 0b01010011, [25] = 0b00000000, [26] = 0b01010101,
      [27] = 0b00000010, [28] = 0b00001111, [29] = 0b11111111,
